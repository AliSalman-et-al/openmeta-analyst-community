...
class Ui_DataTypePage(object):
    def setupUi(self, DataTypePage):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/dataset-types/one-arm-proportion.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/dataset-types/one-arm-mean.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/dataset-types/single-regression-coefficient.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/dataset-types/generic-effect-size.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.onearm_generic_effect_size_Button.setIcon(icon3)
        self.onearm_generic_effect_size_Button.setIconSize(QtCore.QSize(54, 40))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/dataset-types/two-arm-proportions.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/dataset-types/standardized-mean-difference.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/dataset-types/diagnostic-data.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
