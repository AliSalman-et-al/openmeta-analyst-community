...
class Ui_edit_forest_plot_dlg(object):
    def setupUi(self, edit_forest_plot_dlg):
        ...
        self.content_scroll = QtWidgets.QScrollArea(edit_forest_plot_dlg)
        self.content_scroll.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.content_scroll.setWidgetResizable(True)
        self.content_scroll.setObjectName("content_scroll")
        self.content_scroll_contents = QtWidgets.QWidget()
        self.content_scroll_contents.setObjectName("content_scroll_contents")
        self.content_layout = QtWidgets.QVBoxLayout(self.content_scroll_contents)
        self.content_layout.setObjectName("content_layout")
        self.style_group = QtWidgets.QGroupBox(self.content_scroll_contents)
        ...
        self.appearance_group = QtWidgets.QGroupBox(self.content_scroll_contents)
        ...
        self.groupBox = QtWidgets.QGroupBox(self.content_scroll_contents)
        ...
        self.default_panel = QtWidgets.QGroupBox(self.content_scroll_contents)
        ...
        self.content_layout.addWidget(self.default_panel)
        self.regression_group = QtWidgets.QGroupBox(self.content_scroll_contents)
        ...
        self.content_layout.addWidget(self.regression_group)
        self.gridLayout_4 = QtWidgets.QGridLayout()
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.label_12 = QtWidgets.QLabel(self.content_scroll_contents)
        self.label_12.setObjectName("label_12")
        self.gridLayout_4.addWidget(self.label_12, 0, 0, 1, 1)
        self.label_13 = QtWidgets.QLabel(self.content_scroll_contents)
        self.label_13.setObjectName("label_13")
        self.gridLayout_4.addWidget(self.label_13, 4, 0, 1, 1)
        self.x_ticks_le = QtWidgets.QLineEdit(self.content_scroll_contents)
        self.x_ticks_le.setObjectName("x_ticks_le")
        self.gridLayout_4.addWidget(self.x_ticks_le, 4, 2, 1, 1)
        self.label_14 = QtWidgets.QLabel(self.content_scroll_contents)
        self.label_14.setObjectName("label_14")
        self.gridLayout_4.addWidget(self.label_14, 1, 0, 1, 1)
        self.plot_lb_le = QtWidgets.QLineEdit(self.content_scroll_contents)
        self.plot_lb_le.setObjectName("plot_lb_le")
        self.gridLayout_4.addWidget(self.plot_lb_le, 1, 2, 1, 1)
        self.label_15 = QtWidgets.QLabel(self.content_scroll_contents)
        self.label_15.setObjectName("label_15")
        self.gridLayout_4.addWidget(self.label_15, 2, 0, 1, 1)
        self.plot_ub_le = QtWidgets.QLineEdit(self.content_scroll_contents)
        self.plot_ub_le.setObjectName("plot_ub_le")
        self.gridLayout_4.addWidget(self.plot_ub_le, 2, 2, 1, 1)
        self.label_16 = QtWidgets.QLabel(self.content_scroll_contents)
        self.label_16.setObjectName("label_16")
        self.gridLayout_4.addWidget(self.label_16, 5, 0, 1, 1)
        self.show_summary_line = QtWidgets.QCheckBox(self.content_scroll_contents)
        ...
        self.x_lbl_le = QtWidgets.QLineEdit(self.content_scroll_contents)
        self.x_lbl_le.setObjectName("x_lbl_le")
        self.gridLayout_4.addWidget(self.x_lbl_le, 0, 2, 1, 1)
        self.content_layout.addLayout(self.gridLayout_4)
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.label_3 = QtWidgets.QLabel(self.content_scroll_contents)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_4.addWidget(self.label_3)
        self.image_path = QtWidgets.QLineEdit(self.content_scroll_contents)
        self.image_path.setText("")
        self.image_path.setObjectName("image_path")
        self.horizontalLayout_4.addWidget(self.image_path)
        self.save_btn = QtWidgets.QPushButton(self.content_scroll_contents)
        self.save_btn.setObjectName("save_btn")
        self.horizontalLayout_4.addWidget(self.save_btn)
        self.content_layout.addLayout(self.horizontalLayout_4)
        self.content_scroll.setWidget(self.content_scroll_contents)
        self.verticalLayout.addWidget(self.content_scroll)
    ...
    def retranslateUi(self, edit_forest_plot_dlg):
        ...
        self.col1_str_edit.setText(
            _translate("edit_forest_plot_dlg", "Study or Subgroup")
        )
        ...
        self.col3_str_edit.setText(_translate("edit_forest_plot_dlg", "[default]"))
        ...
        self.col4_str_edit.setText(_translate("edit_forest_plot_dlg", "[default]"))
        ...
        self.regression_group.setTitle(
            _translate("edit_forest_plot_dlg", "Regression Options")
        )
        self.show_regression_line.setText(
            _translate("edit_forest_plot_dlg", "Show regression line")
        )
        self.show_confidence_band.setText(
            _translate("edit_forest_plot_dlg", "Show confidence band")
        )
        self.show_prediction_interval.setText(
            _translate("edit_forest_plot_dlg", "Show prediction interval")
        )
