...
def compare_golden_baseline(reference, modern, exceptions=None, manifest=None):
    exceptions = exceptions or []
    manifest_rows = _manifest_rows(manifest)
    modern_by_id = _by_id(modern.get("curated_golden_set", modern.get("results", [])))
