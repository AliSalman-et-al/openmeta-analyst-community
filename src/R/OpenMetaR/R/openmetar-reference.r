...
#'
#' OpenMetaR represents imported study data with S4 classes. These classes carry
...
#' @name openmetar-data-classes
NULL

#' Binary outcome analysis functions
#'
#' Functions for binary meta-analysis endpoints. OpenMetaR supports inverse
...
#' method contract consumed by the OpenMeta-Analyst UI and Python adapter.
#'
...
#'
#' @section References:
#' See \code{openmetar.method.references("rma.uni.fixed")},
#' \code{openmetar.method.references("rma.uni.random")},
#' \code{openmetar.method.references("rma.mh")}, and
#' \code{openmetar.method.references("rma.peto")} for the statistical method
...
#' @name openmetar-binary-methods
NULL

#' Continuous outcome analysis functions
#'
#' Functions for continuous meta-analysis endpoints. OpenMetaR supports
...
#'
#' @section References:
#' See \code{openmetar.method.references("rma.uni.fixed")} and
#' \code{openmetar.method.references("rma.uni.random")} for the statistical
...
#' @name openmetar-continuous-methods
NULL

#' Diagnostic test accuracy analysis functions
#'
#' Functions for diagnostic test accuracy meta-analysis. OpenMetaR supports
...
#' See \code{openmetar.method.references("rma.uni.fixed")},
#' \code{openmetar.method.references("rma.uni.random")},
#' \code{openmetar.method.references("rma.mh")},
#' \code{openmetar.method.references("rma.peto")},
#' \code{openmetar.method.references("hsroc")}, and
#' \code{openmetar.method.references("diagnostic.bivariate")} for the
...
#' @name openmetar-diagnostic-methods
NULL
...
#'
#' @section References:
#' See \code{openmetar.method.references("hsroc")} for the HSROC statistical
#' method citations used in result payloads.
#'
...
#'
#' @section References:
#' See \code{openmetar.method.references("bootstrap")} for the bootstrap
#' method citations used in result payloads.
#'
...
#'
#' @section References:
#' See \code{openmetar.method.references("meta.regression")} for the
...
#' @name openmetar-meta-regression
NULL

#' Forest plot and display data builders
#'
#' Functions that turn analysis results into OpenMeta-Analyst plot data,
...
#' @name openmetar-data-completion
NULL
