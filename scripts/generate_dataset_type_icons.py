...
def _diagnostic() -> None:
    ...
    axes.plot((0.27, 0.32, 0.41), (0.68, 0.62, 0.72), color="white", linewidth=1.5)
    axes.plot((0.59, 0.73), (0.27, 0.41), color="white", linewidth=1.5)
    axes.plot((0.73, 0.59), (0.27, 0.41), color="white", linewidth=1.5)
