...
This supersedes the earlier bundled-HSROC assumption in ADR 0055 and keeps the source tree focused on maintained project code while still using the latest available archived `HSROC` release.
