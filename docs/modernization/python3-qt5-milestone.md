...
- The legacy Python 2 and PyQt4 Windows CI/build path stayed alive until the modern path replaced it. It is now retired. See [ADR 0021](../adr/0021-keep-the-legacy-ci-path-until-the-port-replaces-it.md).
...
- Track release readiness in [Modern Windows Release Readiness](modern-windows-release-readiness.md) and [Modern Windows Cutover Checklist](modern-windows-cutover-checklist.md).
...
- The modern path is the maintained release path after satisfying all cutover criteria.
